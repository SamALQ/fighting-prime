  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <Container>
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-baseline">
              <h1 className="text-3xl font-bold tracking-tight text-white">FIGHTING PRIME</h1>
              <span className="text-[10px] leading-none ml-[-6px] text-white/70">®</span>
            </div>
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="text-right text-sm">
                ...
                <div className="text-white/60 text-xs">(GMT)</div>
              </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        {/* Background with Eye/Face - placeholder for actual image */}
        <div className="absolute inset-0">
          <div className="absolute left-0 top-0 w-[60%] h-full">
            <div className="relative w-full h-full">
              {/* Placeholder for dramatic eye/face image */}
              {/* In production, replace with: <Image src="/path-to-eye-image.jpg" fill className="object-cover" /> */}
              <div className="absolute inset-0 bg-gradient-to-r from-amber-900/30 via-amber-800/20 to-transparent" />
              {/* Simulated light source from top-right */}
              <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-gradient-to-br from-amber-500/40 via-amber-600/20 to-transparent blur-3xl" />
            </div>
          </div>
        </div>

        {/* Content Overlay */}
        <Container className="relative z-10 h-full min-h-screen">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-screen pt-20">
            {/* Left side - space for image visual */}
            <div className="hidden lg:block lg:col-span-5" />

            {/* Right side - Large Stacked Text */}
            <div className="lg:col-span-7 space-y-1 text-left">
              <h2 className="text-7xl md:text-8xl lg:text-9xl font-black leading-[0.85] tracking-[-0.02em] text-white">
                Train
              </h2>
              <h2 className="text-7xl md:text-8xl lg:text-9xl font-black leading-[0.85] tracking-[-0.02em] text-white">
                Like a Pro.
          ...
          <div className="absolute bottom-16 left-4 lg:left-12 max-w-lg z-20">
            <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
              Elite Muay Thai courses led by
            </p>
            <p className="text-lg md:text-xl text-white/90 leading-relaxed font-light">
              ONE Championship athlete Jake Peacock.
            </p>
          </div>
        </Container>
      </section>
